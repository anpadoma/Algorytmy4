...
public class Transaction implements Comparable<Transaction> {
    ...
    private final double  amount;   // Wartoœæ
    ...
    // Tworzy now¹ transakcjê przez przetworzenie ³añcucha znaków w postaci: nazwisko,
    // data, liczba rzeczywista (dane s¹ rozdzielone odstêpami)
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("Posortowane wed³ug wartoœci");

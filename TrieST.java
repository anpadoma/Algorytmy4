 ...
 *
 *  Tablica symboli na ³añcuchy znaków ASCII, zaimplementowana za pomoc¹ 256-kierunkowego drzewa trie.
 *
...
public class TrieST<Value> {
    private static final int R = 256;        // Rozszerzony zbiór ASCII
    ...
    ****************************************************/
    ...
    // Znajdowanie klucza, który jest najd³u¿szym przedrostkiem s
    public String longestPrefixOf(String query) {
        int length = longestPrefixOf(root, query, 0, 0);
        return query.substring(0, length);
    }

    // Znajdowanie w poddrzewie o korzeniu w x klucza, który jest najd³u¿szym
    // przedrostkiem ³añcucha z zapytania i zaczyna siê od d-tego znaku
